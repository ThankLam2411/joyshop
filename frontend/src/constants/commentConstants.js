...
export const COMMENT_LIST_ALL_REQUEST = 'COMMENT_LIST_ALL_REQUEST';
export const COMMENT_LIST_ALL_SUCCESS = 'COMMENT_LIST_ALL_SUCCESS';
export const COMMENT_LIST_ALL_FAIL = 'COMMENT_LIST_FAIL';
